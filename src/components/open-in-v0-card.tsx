          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex w-full flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-16">
              ...
              <div className="flex items-center gap-1 sm:ml-auto">
                ...
                <Link href={v0Url} target="_blank" rel="noopener noreferrer">
                  <Button className="bg-black text-white shadow-none hover:bg-black hover:text-white dark:bg-white dark:text-black">
                    Open in
                    <svg
